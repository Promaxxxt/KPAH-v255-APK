...
rm -rf dgs095
mkdir -p dgs095
base64 --decode dgs095-source.zip.b64 > dgs095.zip
unzip -q dgs095.zip -d dgs095
...
test -s DragonGameStudio-0.9.5-debug.apk
"$SDK/build-tools/34.0.0/apksigner" verify --verbose --print-certs DragonGameStudio-0.9.5-debug.apk | tee certs.txt
