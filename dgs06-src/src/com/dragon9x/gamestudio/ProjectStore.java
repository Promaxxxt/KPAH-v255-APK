...
/** Local project files. Version 0.6 adds a separate tile bank and reusable effect files. */
...
boolean allowed=name.equals("project.json")||Arrays.asList(ASSETS).contains(name)||name.matches("src/game/[A-Za-z][A-Za-z0-9_]{0,39}\\.gsc")||name.matches("effects/eff_[0-9]{1,5}\\.png");
