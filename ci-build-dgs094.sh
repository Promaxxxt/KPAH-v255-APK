...
rm -rf dgs094
mkdir -p dgs094
base64 --decode dgs094-source.zip.b64 > dgs094.zip
unzip -q dgs094.zip -d dgs094
...
test -s DragonGameStudio-0.9.4-debug.apk
"$SDK/build-tools/34.0.0/apksigner" verify --verbose --print-certs DragonGameStudio-0.9.4-debug.apk | tee certs.txt
