...
rm -rf dgs093
mkdir -p dgs093
base64 --decode dgs093-source.zip.b64 > dgs093.zip
unzip -q dgs093.zip -d dgs093
...
test -s DragonGameStudio-0.9.3-debug.apk
"$SDK/build-tools/34.0.0/apksigner" verify --verbose --print-certs DragonGameStudio-0.9.3-debug.apk | tee certs.txt
